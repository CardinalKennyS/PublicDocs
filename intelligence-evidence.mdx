...
<Warning title="Pilot development">
  Normalized evidence and replaceable provider adapters are under active development. External coverage depends on approved licences, credentials, networks, and provider availability. Cardinal does not claim universal tracing or complete compliance coverage.
</Warning>
