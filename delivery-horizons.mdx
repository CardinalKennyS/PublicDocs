...
| Investor-demo priority | One clear product gateway; business customer login; deterministic `ALLOW`, `REVIEW`, and `BLOCK`; source and freshness; matched rules; professional report download; property-payment demonstration; mobile presentation; clearly labelled Protected Settlement architecture preview. |
