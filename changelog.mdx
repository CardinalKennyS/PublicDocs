...
The current application feature branches also contain a unified product gateway, separate business-customer sign-in, a white-labelled property-payment demonstration, branded comprehensive reports, and structured institution-attribution fields. These items require reviewed merge and production publication confirmation before they are represented as generally available.

The coordinated admin feature branches add direction-aware protection checks, evidence and matched-rule counts, generated-report metadata, partner ownership, and an honest support-readiness view. Central customer-portal records, Escrow event ingestion, inbound support tickets, a dedicated support mailbox, and a response SLA remain unreleased.
